# آرشیو — نقشه راه سه‌جانبهٔ قدیمی

> **ARCHIVED / HISTORICAL ONLY — مسیر AIIF/bootcamp به درخواست مالک پروژه از برنامهٔ فعال خارج شده
> است. برای مسیر فعلی به `ROADMAP.md` و برنامهٔ تجاری مراجعه کنید.**
